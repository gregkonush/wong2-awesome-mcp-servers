...
- **[Bilig WorkPaper](https://github.com/proompteng/bilig)** - TypeScript WorkPaper MCP server for spreadsheet-style cell edits, formula recalculation, JSON persistence, and verified readback.
